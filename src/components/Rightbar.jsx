    ...
    <Box flex={2} p={2} sx={{display: {xs: 'none', sm: 'block'}}}>
      <Box position="fixed" width={300}>
        ...
        <AvatarGroup max={7}>
          ...
          <Avatar alt="Rick Morty" src="" />
          <Avatar alt="Ann Colt" src="https://material-ui.com/static/images/avatar/4.jpg" />
          <Avatar alt="Trevor Henderson" src="https://material-ui.com/static/images/avatar/5.jpg" />
          <Avatar alt="David Sharp" src="https://material-ui.com/static/images/avatar/6.jpg" />
          <Avatar alt="Jessica Wheeler" src="https://material-ui.com/static/images/avatar/7.jpg" />
